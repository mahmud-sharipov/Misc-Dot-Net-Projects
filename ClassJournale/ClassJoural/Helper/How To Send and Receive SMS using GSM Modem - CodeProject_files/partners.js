...
_oiqq.push(['oiq_addPageCat','Telephone']);
...
(function() {
  var shrLoccLoader = setInterval(function() {
    if (document.body) {
      ...
      locc_pixel.src = document.location.protocol + "//sync.crwdcntrl.net/map/c=9193/tp=SHLC/tpid=7a5c4795-0608-47c3-866c-b3630611254a";
...
(function() {
    ...
    locc_human.src = document.location.protocol + '//n-cdn.areyouahuman.com/play/YNMJrK4lsMAJlxSsJDb17LW8YmmHRLakZxkWagp6?AYAH_F2=codeproject.com&AYAH_P2=7a5c4795-0608-47c3-866c-b3630611254a&AYAH_F1=Lotame';
